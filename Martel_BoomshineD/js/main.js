...
app.main = {
    ...
    debug: true,
	//new constants from B-I.5-6
	/*NUM_CIRCLES_START: 5,
	START_RADIUS : 8, // starting circle radius
	MAX_SPEED : 80, // pixels-per-second*/ //Removed for C.I.1
	CIRCLE_STATE: 
	{
		// fake enumeration, actually an object literal
		NORMAL : 0,
		EXPLODING : 1,
		MAX_SIZE : 2,
		IMPLODING : 3,
	...
	makeCircles: function(num)
	{
		...
		for(var i=0; i<num;i++)
		{
			...
			//.x and .y are somwhere on the canvas, with a minimum margin of START_RADIUS
			...
			//mo more properties can be added!
			Object.seal(c);
			array.push(c);
		}
		return array;
	...
	doMousedown: function(e)
	{
		...
		if(main.paused){  main.paused = false;  main.update();  return; };
